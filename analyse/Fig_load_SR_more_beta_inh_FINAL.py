...
myDir = "../../data/all_data_splited/sleep_simulations/Fig_load_SR_many_beta_diag_inh_sleep_more_beta"
...
betas_to_plot = all_beta        # or slice / mask as you like
...
plt.savefig("./plots/Fig_load_SR_more_beta_diag_inh.png",dpi=300)


#%%
beta_val = all_beta[0]          # ← pick the β you want to inspect
