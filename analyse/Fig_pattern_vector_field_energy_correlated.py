...
def plot_combined_landscape(vector_field_file, energy_field_file):
    ...
    vmin = np.min(E)
    vmax = np.max(E)
    contour = ax2.contourf(EX, EY, E, 20, cmap='viridis', vmin=vmin, vmax=vmax)
...
def plot_all_stages(folder, stages):
    ...
    for stage in stages:
        ...
        try:
            ...
            fig, _ = plot_combined_landscape(vector_field_file, energy_field_file)
...
if __name__ == "__main__":
    folder = "../../data/all_data_splited/trained_networks_fast/Fig_patterns_vector_field_energy/sim_nb_1/"
