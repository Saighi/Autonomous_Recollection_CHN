...
myDir = "../../data/all_data_splited/sleep_simulations/Fig_load_SR_average_new_inh_plas_big_simulations_many_beta_2025_optimized"
...
betas_to_plot = all_beta[1:-1]        # or slice / mask as you like
...
plt.savefig("./plots/Fig_load_SR_average_betas.png",dpi=300)
plt.show()
