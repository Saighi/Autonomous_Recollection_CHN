...
for i, correlation in enumerate(correlation_to_plot):
    ...
    axes[0, i].set_title(rf"$\rho={1-correlation}$")
...
cbar2_ax = fig.add_axes([0.92, 0.135, 0.01, 0.3])
...
plt.savefig("./plots/Fig_load_SR_average_correlations.png",dpi=300)

#%%
beta_val = 0.00125          # ← pick the β you want to inspect
