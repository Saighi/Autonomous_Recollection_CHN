...
for sim_id in sim_IDs:
    ...
    if len(sim_data_all_patterns_fnd)==0:
        ...
        first_iter_all_fnd=sim_data_all_patterns_fnd[sim_data_all_patterns_fnd['query_iter']==sim_data_all_patterns_fnd["query_iter"].min()]
        error_ratio=list(first_iter_all_fnd['nb_spurious']/first_iter_all_fnd["query_iter"])[0]
        if error_ratio>0:
            is_error=True
