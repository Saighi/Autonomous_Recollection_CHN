...
void run_simulation(int sim_number, unordered_map<string, double> parameters,
    ...
    double down_lim_vector_field = parameters.at("down_lim_vector_field");
    ...
    //     patterns_rates[0], patterns_rates[1], nb_sample_points_vector_field);
    compute_and_save_potential_vector_field_two_pattern_negative_area(delta,
...
int main(int argc, char **argv) {
    ...
    string sim_name = "Fig_patterns_vector_field_negative_area";
    ...
    unordered_map<string, vector<double>> varying_params = {
        {"beta", {0.35}},
        {"nb_sample_points_vector_field", {10}},
        {"drive_target", {6}},
        ...
        {"noise_level", {1}},
        {"up_lim_vector_field", {2}},
        {"down_lim_vector_field", {-2}}
    };
