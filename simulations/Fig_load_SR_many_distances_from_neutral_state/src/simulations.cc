...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Fig_load_SR_many_distances_from_neutral_with_noise";
    ...
    vector<double> distance_noise_level = {0.0, 0.25, 0.5, 0.75, 1.0}; // Uniform noise in distance from neutral
