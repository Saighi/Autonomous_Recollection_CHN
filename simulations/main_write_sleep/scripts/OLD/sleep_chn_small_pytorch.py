#%%
"""
CHN Sleep Phase (Autonomous Retrieval) - PyTorch Backend for Small Networks
...
Prerequisites: Run write_chn_small_pytorch.py first to generate trained networks.
"""
...
SLEEP_RESULTS_NAME = "comparison_chn_small_pytorch_sleep"
...
#%% Initialize Device
print("=" * 70)
print("CHN SLEEP PHASE - PyTorch (Small Networks)")
print("=" * 70)
...
if not trained_dir.exists():
    raise FileNotFoundError(
        ...
        "Please run write_chn_small_pytorch.py first."
    )
