#!/usr/bin/env python3
"""
CHN Training (Write Phase) - PyTorch GPU Backend for Large Networks

Trains Continuous Hopfield Networks using Adam optimizer on GPU.
Designed for larger networks (N >= 300) where GPU acceleration provides
significant speedup over C++ backend.

Usage:
    python write_chn_large.py

After running, use sleep_chn_large.py for the sleep phase.
"""
...
# Network and pattern parameters (large networks for PyTorch)
NETWORK_SIZES = list(range(250, 501, 25)) 
NUM_PATTERNS = list(range(10, 20, 1))      
...
# Experiment name
EXPERIMENT_NAME = "comparison_chn_pytorch_slightly_larger"
...
if __name__ == "__main__":
    print("=" * 70)
    print("CHN WRITE PHASE - PyTorch GPU (Large Networks)")
    print("=" * 70)
    ...
    print(f"Next: Run sleep_chn_large.py")
    print("=" * 70)
