# %% [markdown]
# # Heterogeneous Sparsity Exploration
#
# This script tests the new heterogeneous pattern generation:
# 1. Trains a 250-unit network on 10 patterns with varying sparsities
...
from utils import (
    generate_patterns_heterogeneous,
    create_pattern_metadata,
    write_pattern_metadata,
...
BETA = 0.025               # Inhibitory plasticity rate
...
# Experiment name
EXPERIMENT_NAME = "heterogeneous_sparsity_exploration"
...
# %% [markdown]
# ## Phase 2: Generate Heterogeneous Patterns

# %% Generate patterns
print("="*70)
print("GENERATING HETEROGENEOUS PATTERNS")
print("="*70)
...
patterns, per_pattern_metadata = generate_patterns_heterogeneous(
    k=NUM_PATTERNS,
    n=NETWORK_SIZE,
...
metadata = create_pattern_metadata(
    ...
    per_pattern_data=per_pattern_metadata
)

print(f"Generated {NUM_PATTERNS} patterns with heterogeneous sparsities:\n")
...
if not metadata_path.exists():
    # Try trained networks as fallback
...
# Save figure
output_path = Path(__file__).parent.parent / "plots" / "heterogeneous_sparsity.png"
