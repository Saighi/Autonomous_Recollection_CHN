...
CORRELATIONS = [0.5]  # Avoid 1.0 (causes infinite loop)
SPARSITY = 0.5

# Experiment names
HEBBIAN_NAME = "comparison_dhn_hebbian_0.5"
STORKEY_NAME = "comparison_dhn_storkey_0.5"
...
HEBBIAN_QUERY_NAME = "comparison_dhn_hebbian_query_0.5"
STORKEY_QUERY_NAME = "comparison_dhn_storkey_query_0.5"
