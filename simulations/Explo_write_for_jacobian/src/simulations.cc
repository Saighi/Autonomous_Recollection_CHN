...
int main(int argc, char **argv)
{
    ...
    // vector<double> num_patterns = generateEvenlySpacedIntegers(1, 25, 10);
    vector<double> num_patterns = {2};
    ...
    vector<double> network_sizes = {25};
    ...
    // vector<double> noise_level = linspace(0.4, 1, 10);
