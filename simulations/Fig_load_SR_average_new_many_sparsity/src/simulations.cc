...
int main(int argc, char **argv)
{
    ...
    //     "new_convergence";
    string sim_name = "Fig_load_SR_average_new_inh_plas_big_simulations_many_sparsity_new_convergence_nb_iter";
    ...
    vector<double> noise_level = {0.5};
    vector<double> relative_nb_winner = {0.1,0.3,0.5,0.7,0.9};
    ...
    unordered_map<string, vector<double>> varying_params = {
        ...
        {"relative_nb_winner", relative_nb_winner},
