...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Fig_load_SR_average_many_epsilon";
    ...
    vector<double> num_patterns = generateEvenlySpacedIntegers(1, 25, 30);
    //vector<double> num_patterns = generateEvenlySpacedIntegers(1, 3, 3);
    // vector<double> num_patterns = {6};
    vector<double> drive_targets = {6};
    vector<double> network_sizes = generateEvenlySpacedIntegers(25, 350, 10); 
    ...
    vector<double> epsilon_learning = {0.0001, 0.0001 / 100,
                                       0.0001 / 10000, 0.0001 / 1000000};
    ...
    unordered_map<string, vector<double>> varying_params = {
        ...
        {"epsilon_learning", epsilon_learning},
        {"delta", {0.1}},
        {"init_drive", {0.5}},
        {"leak", {1}}};
