...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Fig_load_SR_average_new_inh_plas_big_simulations_many_beta_2025";
    string inputs_name = "Fig_load_SR_average_new_inh_plas_big_simulations";
    ...
    unordered_map<string, vector<double>> varying_params = {
        {"save", {0}},
        {"beta", {0.00125/4,0.00125,0.0035,0.005,0.01}},
        {"delta",{0.01}},
        {"noise",{1}},
        {"stddev",{0.01}},
        {"typicall_mult",{4.0}},
