...
{
    // string sim_name = "write_parameter_simple_one_network_various_steepness";
    ...
    vector<double> all_relative_num_patterns = linspace(0.3,0.8,10);
    vector<double> steepnesses = linspace(0.5,3,10);
