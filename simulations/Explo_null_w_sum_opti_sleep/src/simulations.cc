...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Explo_null_w_sum";
    string inputs_name = "Explo_null_w_sum";
    ...
    // vector<double> beta = {0.00125 / 10, 0.00125 / 4, 0.00125, 0.0035};
    vector<double> beta = {0.00125 / 10};
    ...
    filterLastQueryIterations(foldername_results + "/all_simulation_data.csv",
                              foldername_results + "/all_simulation_last_iter_data.csv");
    return 0;
}
