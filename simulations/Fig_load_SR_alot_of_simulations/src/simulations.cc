...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Fig_load_SR_alot_of_simulations";
    ...
    vector<double> network_sizes = generateEvenlySpacedIntegers(150, 250, 10);
    vector<double> iterations = generateEvenlySpacedIntegers(0,300, 300);
