...
int main(int argc, char **argv)
{
    ...
    string sim_name = "investigate_spurious_write";
    ...
    // vector<double> network_sizes = generateEvenlySpacedIntegers(25, 250, 20);
    vector<double> network_sizes = {214};
    ...
    // vector<double> noise_level = {0.5};
    vector<double> repetition = generateEvenlySpacedIntegers(0,1000,1000);
