...
int main(int argc, char **argv)
{
    ...
    string sim_name = "Fig_load_SR_average_new_inh_plas_big_simulations_many_correlations_2025";
    string inputs_name = "Fig_load_SR_average_new_inh_plas_big_simulations_many_correlations";
