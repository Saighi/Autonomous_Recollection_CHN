...
class Network{
    public:
        ...
        std::vector<std::vector<bool>> engram_matrix;
        ...
        void reinforce_attractor_hebbian(std::vector<bool>, double);
        void reinforce_attractor_bistability(std::vector<double>, double, double, double );
        void pot_inhib(double);
        // void pot_inhib_normalize(double, int);
        void iterative_normalize_inhib(int, double);
        void reset_inhib();
        void add_engram(std::vector<bool>);
        void potentiate_engrams(double);
};      
