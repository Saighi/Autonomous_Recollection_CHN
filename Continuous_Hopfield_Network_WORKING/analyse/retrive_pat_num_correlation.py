...
base_folder = "..\\..\\..\\data\\all_data_splited\\sleep_simulations\\sleep_parameter_test_correlation_fixed_size"
...
for idx, correlation_pat in enumerate(correlation_values):
    ...
    for idx_2,nb_pat in enumerate(number_patterns):
        structured_data = relative_nb_found_iter_beta_fixe_num_pat(all_data, correlation_pat, nb_pat)
        # Plotting for number of patterns fixed
        legend = []
        it = 0
        for key in betas:
