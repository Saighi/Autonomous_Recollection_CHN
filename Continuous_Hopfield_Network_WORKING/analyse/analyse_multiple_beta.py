...
for h in range(nb_betas):
    ...
    for i in range(nb_phases):
        data_sleep_phases[-1].append(np.loadtxt("../../data/spontaneous_recollection_all_betas/output_sleep_"+str(h)+"_"+str(i)+".data"))
data_sleep_phases = np.array(data_sleep_phases)
patterns = np.loadtxt("../../data/spontaneous_recollection_all_betas/output_sleep_patterns.data")
#%%
patterns.size
# %%
